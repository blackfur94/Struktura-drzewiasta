...
<body>
<div id="container">
<div id="wb_wczytaj_baze" style="position:absolute;left:348px;top:857px;width:148px;height:52px;z-index:48;">
<form name="wczytaj_baze" method="post" action="./index.php" id="wczytaj_baze">
<input type="hidden" name="form_name" value="wczytaj_baze">
</form>
</div>
<input type="text" id="search" style="position:absolute;left:522px;top:869px;width:253px;height:30px;z-index:49;" name="search" value="" maxlength="250" tabindex="12" autocomplete="off" spellcheck="false">
<div id="Html3" style="position:absolute;left:0px;top:270px;width:994px;height:564px;overflow:auto;z-index:50">
<div id="tree-container"></div></div>
<div id="Layer5" style="position:absolute;text-align:left;left:0px;top:19px;width:994px;height:241px;z-index:51;">
<div id="Layer4" style="position:absolute;text-align:left;left:0px;top:0px;width:231px;height:241px;z-index:16;">
<div id="wb_nowy_wezel" style="position:absolute;left:0px;top:15px;width:221px;height:208px;z-index:5;">
...
<input type="submit" id="Button1" name="" value="Dodaj węzeł" style="position:absolute;left:0px;top:161px;width:210px;height:40px;z-index:0;" tabindex="3">
<select name="rodzic" size="1" id="rodzic" style="position:absolute;left:0px;top:109px;width:210px;height:33px;z-index:1;" tabindex="2">
<option selected>Wybierz...</option>
</select>
<div id="wb_Text7" style="position:absolute;left:0px;top:80px;width:135px;height:18px;z-index:2;">
<span style="color:#000000;font-family:Arial;font-size:15px;"><strong>Rodzic węzła:</strong></span></div>
<input type="text" id="nazwa" style="position:absolute;left:0px;top:32px;width:192px;height:23px;z-index:3;" name="nazwa" value="" maxlength="250" tabindex="1" autocomplete="off" spellcheck="false">
<div id="wb_Text8" style="position:absolute;left:0px;top:3px;width:183px;height:18px;z-index:4;">
<span style="color:#000000;font-family:Arial;font-size:15px;"><strong>Nazwa nowego węzła:</strong></span></div>
</form>
</div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:242px;top:78px;width:247px;height:162px;z-index:17;">
<div id="wb_zmien_rodzica" style="position:absolute;left:19px;top:9px;width:210px;height:136px;z-index:9;">
...
<select name="nowy_rodzic" size="1" id="nowy_rodzic" style="position:absolute;left:0px;top:37px;width:210px;height:33px;z-index:6;" tabindex="4">
<option selected>Wybierz...</option>
</select>
<input type="submit" id="Button4" name="" value="Przenieś węzeł" style="position:absolute;left:0px;top:90px;width:210px;height:39px;z-index:7;" tabindex="5">
<div id="wb_Text5" style="position:absolute;left:0px;top:8px;width:183px;height:18px;z-index:8;">
<span style="color:#000000;font-family:Arial;font-size:15px;"><strong>Nowy rodzic węzła:</strong></span></div>
</form>
</div>
</div>
<div id="Layer3" style="position:absolute;text-align:left;left:503px;top:78px;width:247px;height:162px;z-index:18;">
<div id="wb_Form1" style="position:absolute;left:19px;top:9px;width:210px;height:136px;z-index:13;">
...
<input type="submit" id="Button5" name="" value="Zmień nazwę" style="position:absolute;left:0px;top:90px;width:210px;height:39px;z-index:10;" tabindex="7">
<div id="wb_Text6" style="position:absolute;left:0px;top:8px;width:183px;height:18px;z-index:11;">
<span style="color:#000000;font-family:Arial;font-size:15px;"><strong>Nowa nazwa węzła:</strong></span></div>
<input type="text" id="nowa_nazwa" style="position:absolute;left:0px;top:37px;width:192px;height:23px;z-index:12;" name="nowa_nazwa" value="" maxlength="250" autocomplete="off" spellcheck="false" title="6">
</form>
</div>
</div>
<div id="Layer2" style="position:absolute;text-align:left;left:761px;top:159px;width:232px;height:81px;z-index:19;">
<div id="wb_usun_wezel" style="position:absolute;left:13px;top:11px;width:219px;height:53px;z-index:15;">
...
<input type="submit" id="Button7" name="" value="Usuń węzeł" style="position:absolute;left:9px;top:7px;width:210px;height:39px;z-index:14;" tabindex="8">
</form>
</div>
</div>
</div>
...
<div id="Html4" style="position:absolute;left:1039px;top:418px;width:100px;height:100px;z-index:54">
<script>
...
<input type="button" id="Button2" onclick="rozwinDrzewo();return false;" name="" value="Rozwiń / zwiń drzewo" style="position:absolute;left:0px;top:869px;width:210px;height:40px;z-index:58;" tabindex="9">
<input type="button" id="Button8" onclick="przeszukajDrzewo();return false;" name="" value="Wyszukaj w drzewie" style="position:absolute;left:783px;top:869px;width:210px;height:40px;z-index:59;" tabindex="13">
<input type="submit" id="Button6" name="" value="Zresetuj drzewo" style="position:absolute;left:261px;top:869px;width:210px;height:39px;z-index:60;" tabindex="11">
</div>
<script>
